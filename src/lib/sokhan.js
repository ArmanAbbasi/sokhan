 ...
 */
/* globals browser, speechSynthesis */
...
class Sokhan {
    ...
    bindEvents() {
        ...
        //     if (!helper.isElementHidden(i) && helper.isElementInViewport(i)) {
        //         document.addEventListener('focus', (e, i) => this.elementFocused(e, i));
        //     }
        // }
    }
    ...
    //
    // sokhan(text) {
    //     if (!store.isSokhanActive()) { return; }
    //
